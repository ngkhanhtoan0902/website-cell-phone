        ...
        <div class="col-10 col-xxl-10 mx-auto">
            <div class=" rsolution-card-shadow">
                ...
                <div class="rsolution-card-body">
                    <form id="form-create" action="{{ route('rcms.materials.store') }}" method="post"
                                ...
                                <div class="row">
                                    <div class="col-6 mb-3">
                                        ...
                                        <select name="category_id" class="form-control" required>
                                            ...
                                            @foreach ($categories as $cate)
                                                <option value="{{ $cate->id }}" data-slug="{{ $cate->slug }}">
                                                    {{ $cate->title }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                    <div class="col-6 mb-3">
                                        ...
                                        <div class="input-group">
                                            <textarea class="form-control" name="form_submit"></textarea>
                                        </div>
                                    </div>
                                    <div class="col-6">
                                        <label for="">Related Materials<span
                                                class="text-danger fs-18"></span></label>
                            ...
                            <div class="col-6">
                                <div class="row">
                                    ...
                                    <div class="col">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input id="graphic" class="form-control" type="text" name="graphic"
                                                value="{{ old('graphic') }}" accept="image/png, image/gif, image/jpeg"
                                                required>
                                        </div>
                                    ...
                                    <div class="col">
                                        ...
                                        <div class="input-group">
                                            <input type="button" data-target="lfm-image" data-input="preview"
                        ...
                        <div class="form-group row">
                            <div class="col-3">
                                ...
                                <div class="input-group mb-10">
                                    <input class="p-0" type="file" value="Upload" name="file">
                                </div>
                            </div>
                            <div class="col-4">
                                <label for="name">Url</label>
                                <div class="input-group">
                                    <input class="form-control" type="text" name="material_folder" value=""
                                        placeholder="Folder">
                                    <input class="form-control" type="text" name="material_file" value=""
...
@section('js')
    <script>
        ...
        $('[name="material_file"]').keyup(function() {
